...
export default function SponsorshipTileSingle({ className, packagePrice = "£0", packageTier="package-tier", packageColour="gray", children }: SponsorshipTileProps) {
  return (
    <div className={`bg-[#f5ebe1] w-64 h-84 px-5 py-2 items-start justify-center rounded-2xl mx-2 ${className || ''}`}>
      ...
      <div className="py-4 flex flex-col w-34 items-center justify-center">
      {children}
      </div>
      <div 
        style={{ backgroundColor: packageColour }} 
